...
_LLM_SYSTEM_PROMPT = (
    ...
    "NEVER fuse a color into a species name: emit the species tag and the fur-color "
    "tag as two separate tags, always. Examples: "
    "'chubby character' -> plump (NOT chubby); "
    "'mismatched eye colors' -> heterochromia; "
    "'white rabbit' -> rabbit, white_fur (NOT white_rabbit); "
    "'brown bear' -> bear, brown_fur (NOT brown_bear); "
    "'black cat' -> cat, black_fur (NOT black_cat); "
